...
int i,n, a[10], s=0, v, max=0,k, min = a[0];
 printf("Enter to print even and values of the array. 1 Enter 2 to print arm and avarage of the elements of the array in Entor 3 to print max and 12 min value \n");
